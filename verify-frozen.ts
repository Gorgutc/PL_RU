...
async function testWorkspaceShellContract() {
  ...
  failures.push(
    ...
    ...missingSnippets(tabSidePanel, [
      ...
      'testId="kick-combobox-pz-number"',
      'testId="kick-combobox-warhead-type"',
      'testId="kick-combobox-pampushka"',
      'testId="kick-combobox-fork"',
      'testId="kick-combobox-radish"',
      'testId="kick-combobox-camera"',
      'testId="kick-combobox-interest"',
    ...
    ...missingSnippets(workspaceSpec, [
      ...
      'makes launch dropdown fields editable with option stubs',
    ...
    ...missingSnippets(frozen, [
      ...
      'shared editable dropdown',
      'native `datalist` with 2-3 temporary',
