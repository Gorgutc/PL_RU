...
- Link `colors_and_type.css` + `components.css` (or inline them — see *Caveats* below).
...
- **Background is *void* black** `#04040A` / `#06060C` — never pure `#000`.
...
- *What kind of artifact?* (slide deck, dashboard mock, marketing landing, splash screen, prototype, production component)
- *Which OSIRIS surface?* (the main map dashboard, the RECON toolkit, a focused panel, a new feature)
- *How much fidelity?* (sketch with placeholders / hi-fi pixel-perfect / production-ready)
- *Animated or static?*
- *Any specific copy or data they want represented?*
