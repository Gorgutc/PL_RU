...
8. Treat `.codex/` as a convenience mirror, not the source of truth.
9. Before delivery, run the appropriate quality command and report failures.
10. End completed work with a concise handoff summary so Codex Memories can carry
