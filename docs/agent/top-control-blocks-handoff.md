...
- [~] `map` (Оперативная карта) — datetime + Тип данных готовы; иконочные группы (Инфраструктура/Наложения/Борты/Слои) — TODO (манифест иконок)
