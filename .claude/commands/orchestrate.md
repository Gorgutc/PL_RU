...
`Catalog candidates` / `Reason`). Подними применимые read-only субагенты из
`.claude/agents/*` по контракту промптов/выводов (Goal / Success Criteria /
Documentation / Ownership / Verification / Stop Rules / PASS-FAIL). Заверши
аудит-матрицей: `keep / fix / remove / archive / needs user decision`.
